...
clear all
close all
%color_trans = {'k','g','c','m','b'};
%line_type = {'k-.','g-','c-','m-','b-','k-','r:','g:','b:','m:','c:','k:'};
color_trans = {'c','m','b'};
...
%data_name = {'FPC/data','HRRG/data_random','Crowd-BT/data','HRRG/data_active','Hybrid-MST/data'};
%display_name = {'FPC','HRRG','Crowd-BT','Hodge-active','Hybrid-MST'};
data_name = {'Crowd-BT/data','HRRG/data_active','Hybrid-MST/data'};
